...
$address = '10.1.1.165';  // for 'caalm01' 2020/4/20;
$port = 443;
$username = 'ttpro';
$password = 'ap4ttpro!';
...
echo "after stream_context_create<br>\n";
	$count = 0;
	if ($sock = stream_socket_client('ssl://'.$address.':'.$port, $err_no, $err_str,3,STREAM_CLIENT_CONNECT,$context))  {
echo "after stream_socket_client<br>\n";
		$byte_written = fwrite($sock , $msg2socket);
echo "byte written = " . $byte_written . "<br>\n";
...
function project_list($h, $p , $u , $pa)
{
