...
if ( $last_period != 'Week' and $last_period != 'BiWeek' and $last_period != 'Month' and $last_period != 'Year') {
	...
	$arr = ttpro::query_ttpro_ref('Newly Found ' . substr($last_period , 0 , 01));
...
<b>Duration: </b><input type=radio name=period style='color:green' onClick="location.href='byref2.php?last=Week'" value="Week" <?php if ($last_period == "Week") echo "checked" ?> >Week
<input type=radio name=period style='color:green' onClick="location.href='byref2.php?last=BiWeek'" value="BiWeek" <?php if ($last_period == "BiWeek") echo "checked" ?> >BiWeek
<input type=radio name=period style='color:blue' onClick="location.href='byref2.php?last=Month'" value="Month" <?php if ($last_period == "Month") echo "checked" ?>>Month
<input type=radio name=period style='color:black' onClick="location.href='byref2.php?last=Year'" value="Year" <?php if ($last_period == "Year") echo "checked" ?>>Year
