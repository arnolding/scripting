...
$log_msg = $date_tag . "UserName: [" . $_COOKIE["db_mediawikiUserName"] . "], REMOTE_ADDR: [" .
		$_SERVER["REMOTE_ADDR"] . "], SCRIPT: [" . $_SERVER["SCRIPT_NAME"] . " with " .
		$from . " to " . $to . " logonly " . $logonly . "]\n";
...
date_default_timezone_set('America/Los_Angeles');
	...
	$query_str = "{'Number':{'&lt;numbers&gt;':[30003,30002]}}";
