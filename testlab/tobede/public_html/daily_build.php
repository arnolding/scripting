...
//	$sql .= "where check_date > '2015-12-19 00:00:00' group by check_date,platform,version";
	$sql = "select * from daily_build where check_date > '2016-12-19 00:00:00' order by object_mdate,platform,version";
}
