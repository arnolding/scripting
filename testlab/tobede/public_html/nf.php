...
//	echo "<br><br>Column List ====<br><br>" . $clist . "<br><br>";
	$rlist = record_estimate($cookie, 'Newly Found ' . substr($last_period,0,1));
...
Duration: <input type=radio name=period style='color:green' onClick="location.href='nf.php?last=Week'" value="Week" <?php if ($last_period == "Week") echo "checked" ?> >Week
<input type=radio name=period style='color:green' onClick="location.href='nf.php?last=BiWeek'" value="BiWeek" <?php if ($last_period == "BiWeek") echo "checked" ?> >BiWeek
<input type=radio name=period style='color:blue' onClick="location.href='nf.php?last=Month'" value="Month" <?php if ($last_period == "Month") echo "checked" ?>>Month
<input type=radio name=period style='color:black' onClick="location.href='nf.php?last=Year'" value="Year" <?php if ($last_period == "Year") echo "checked" ?>>Year
