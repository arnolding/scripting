...
Duration: <input type=radio name=period style='color:green' onClick="location.href='newfound.php?last=Week'" value="Week" <?php if ($last_period == "Week") echo "checked" ?> >Week
